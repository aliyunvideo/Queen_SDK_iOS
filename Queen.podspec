...
Aliyun Render And Compute Everything Engine.
  ...
  s.vendored_frameworks = 'Queen/Libs/queen.framework', 'Queen/Libs/Face3D.framework', 'Queen/Libs/opencv2.framework', 'Queen/Libs/FaceDetection.framework', 'Queen/Libs/MNN.framework', 'Queen/Libs/pixelai.framework', 'Queen/Libs/bokeh_ios.framework'
  ...
  s.weak_frameworks = 'MetalPerformanceShaders', 'CoreML'
