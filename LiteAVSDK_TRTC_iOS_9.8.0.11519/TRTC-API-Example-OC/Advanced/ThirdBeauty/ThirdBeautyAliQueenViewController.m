...
/*
 ...
 2、设置第三方美颜的视频数据回调。      API:[self.trtcCloud setLocalVideoProcessDelegete:self pixelFormat:TRTCVideoPixelFormat_NV12 bufferType:TRTCVideoBufferType_PixelBuffer];
 3、使用第三方美颜SDK<Demo中使用的是AliyunQueen>: API: [self.beautyEngine processPixelBuffer:bufferData];
...
/*
 ...
 2. Set the callback of remote video data for custom rendering: [self.trtcCloud setLocalVideoProcessDelegete:self pixelFormat:TRTCVideoPixelFormat_NV12 bufferType:TRTCVideoBufferType_PixelBuffer];
 3. Use a third-party filter SDK <AliyunQueen is used in the demo>: [self.beautyEngine processPixelBuffer:bufferData];
...
@interface ThirdBeautyAliQueenViewController () <TRTCCloudDelegate, TRTCVideoFrameDelegate>
...
- (void)startPushStream {
    ...
    [self.trtcCloud setLocalVideoProcessDelegete:self pixelFormat:TRTCVideoPixelFormat_NV12 bufferType:TRTCVideoBufferType_PixelBuffer];
...
- (void)processVideoFrameByQueen:(TRTCVideoFrame *)videoFrame
{
#if ENABLE_ALIYUN_QUEEN_BEAUTY
